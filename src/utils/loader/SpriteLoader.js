/**
* Load all the different images and spritesheets of the game
*/
define([
	"underscore",
...
function (
	...
	/**
	 * Load all images and store them in spriteManager
	 */
	...
	/**
	 * Get sound louding progression (0 to 1)
	 */
