...
function (
	...
	/**
	 * Initialize Canvas and set its size based on sized stored in config file or full screen
	 */
	...
	/**
	 * Resize GameContainer automatically if the game is in full screen
	 */
